...
It is particularly important to emphasize that I was not admitted through <strong>Special Admissions for Foreign Nationals (외국인특별전형)</strong> or <strong>Out-of-Quota Admissions (정원외)</strong>. Instead, in 2020, I applied through the <strong>General Admissions (일반전형)</strong> process of Sangmyung University’s General Graduate School under the <strong>Within-Quota Admissions (정원내)</strong> system, competing directly with Korean applicants. I successfully passed the selection process and began my master’s studies in the Department of Global Culture Contents in September 2020.<br><br>
...
その前身にあたる<strong>特殊大学院</strong>は、主として<strong>在職者や社会人など、実務と並行して学ぶ大学院生</strong>を対象とする教育制度であり、一般大学院における全日制の学術研究者養成とは異なる制度的性格を有していた。また、原則として<strong>修士課程を中心に設置され、博士課程を設けない</strong>教育機関であった。<br><br>
...
本人研究生阶段所属学科具有明确的制度沿革与学科历史，其更早阶段可追溯至祥明大学原 <strong>特殊大学院创意内容学科</strong>（韩文原称：<strong>특수대학원 창의콘텐츠학과</strong>）。本人所属的 <strong>全球文化内容学科</strong> 为祥明大学一般大学院于2020年新设的学科（专业），本人亦为该学科 <strong>首位入学的外国籍学生，同时也是首位取得博士学位的外国籍学生</strong>。<br><br>

相较于已具有十年乃至数十年发展历史的传统学科，该学科设立时间较短，其学科体系、培养制度及学位授予机制仍处于逐步建设与完善的阶段，同时受到既有学科制度及历史沿革的影响。这一制度沿革与新设学科的发展背景，对于理解本人学位名称及其制度性特殊性尤为关键。<br><br>
...
<details>
  ...
  <div class="lang-ko">
    ...
    <p>
      동아시아 사회적 맥락과 현대 뉴미디어 시대의 환경 속에서,
      서브컬쳐와 주류문화 간의 융합 및 상호작용 관계에 주목하고,
      문화콘텐츠의 문화적 수출과 역수출 현상 및 문화적 순환 과정을 분석한다.
      또한 글로벌화, 글로컬라이제이션, 혼종화 등 문화의 이행과 전환, 변형 과정을 분석한다.
    </p>

    <p>
      문화혼종 이론 및 그 관점에 기반하여,
      문화콘텐츠 재창조와 의미 재구성의 관점에서
      문화상품 및 미디어 콘텐츠를 심층적으로 분석하고 해석하며,
      서로 다른 사회적·미디어적 맥락 속에서 문화적 의미가 어떻게 생산되고 변형되며 재구성되는지를 탐구한다.
    </p>
  </div>
</details>
...
<details>
  ...
  <div class="lang-ja">
    ...
    <p>
      東アジアの社会的文脈および現代のニューメディア時代の背景のもとで、
      亜文化と主流文化のあいだの融合および相互作用の関係に注目し、
      文化内容の文化的輸出および文化的逆輸出の現象、ならびに文化的循環の過程を分析する。
      さらに、グローバル化、グローカリゼーション、混種化など、文化の移行と転化、変容の過程を分析する。
    </p>

    <p>
      文化的な混種に関する理論およびその見解に基づき、
      文化内容の再創造と意味重構の観点から、
      文化商品および媒体内容を深層的に分析・解釈するとともに、
      異なる社会的・メディア的文脈のなかで文化的意味がどのように生成され、変容し、再構成されるのかを考察する。
    </p>
  </div>
</details>
...
<details>
  ...
  <div class="lang-zh">
    ...
    <p>
      在东亚社会语境与当代新媒体时代背景下，
      重点关注亚文化与主流文化之间的融合及互动关系，
      以及文化内容的文化输出与文化逆输出现象和文化流通过程，
      并分析全球化、全球本土化与混种化等文化迁移、转化与变形过程。
    </p>
    ...
    <p>
      ...
      并探讨文化意义如何在不同社会与媒体语境中被生产、转化与重新建构。
    </p>
  </div>
</details>
